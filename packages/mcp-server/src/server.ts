...
export function initMcpServer(params: {
  ...
  const capabilities = {
    ...defaultClientCapabilities,
    ...(params.mcpOptions.client ? knownClients[params.mcpOptions.client] : {}),
...
export function init(params: {
  ...
  const client = params.client || new TodoNinja({});
...
export function selectTools(endpoints: Endpoint[], options: McpOptions) {
  ...
  if (options.includeDynamicTools) {
    includedTools.push(...dynamicTools(filteredEndpoints));
  }
