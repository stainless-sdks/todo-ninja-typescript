...
The REST API documentation can be found on [docs.todo-ninja.com](https://docs.Todo-Ninja.com). The full API of this library can be found in [api.md](api.md).
...
async function main() {
  const todos: TodoNinja1.TodoListResponse = await client.todos.list();
}
...
```ts
import TodoNinja1 from 'npm:Todo-Ninja';
